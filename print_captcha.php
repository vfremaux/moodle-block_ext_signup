<?php
    ...
    */    
    ...
    if(!isset($SESSION->extsignup->captcha->length)) {
        print_error('errornotallowed', 'block_ext_signup');
    }

    $height = 40;
    $charcount = $SESSION->extsignup->captcha->length;
    ...
    $SESSION->extsignup->captcha->checkchar = $checkchar;
